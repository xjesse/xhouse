...
<div class="g-doc">
  ...
  <div class="m-tab m-tab-fw m-tab-simple f-cb">
        <div class="tab">
            <ul>
                <li <#if !listType  ??|| listType != 1>class="z-sel"</#if> ><a href="/web-ex/api/home">所有内容</a></li>
                <#if user ??&& user.userType == 1>
                <li <#if listType == 1>class="z-sel"</#if> ><a href="/web-ex/api/home?type=1">未购买的内容</a></li></#if>
            </ul>
        </div>
    </div>
    ...
    <div class="n-plist">
        ...
        <#if user ??&& user.userType == 0 && listType == 1>
            <#list productList as x>
                <#if !x.isBuy>
                <li id="p-${x.id}">
                    <a href="/web-ex/api/show?id=${x.id}" class="link">
